...
const MANUAL_ALIAS_GROUPS = [
  ...
  ["KuPS", "KuPS Kuopio", "Kuopion Palloseura"],
  ["Bolton", "Bolton Wanderers", "Bolton Wanderers FC"],
  ["Preston", "Preston North End", "Preston North End FC"],
  ["QPR", "Queens Park Rangers", "Queens Park Rangers FC"],
  ["Kortrijk", "KV Kortrijk", "Royal Kortrijk", "K.V. Kortrijk"],
  ["OH Leuven", "Oud-Heverlee Leuven", "Oud-Heverlee", "OHL"],
  ["Antwerp", "Royal Antwerp", "Royal Antwerp FC"],
  ["Los Angeles Galaxy", "LA Galaxy", "Los Angeles Galaxy FC"],
  ["Celta de Vigo II", "Celta Vigo B", "RC Celta de Vigo B", "Celta B"],
  ["Cadiz", "Cadiz CF"],
  ["England", "Inglaterra"],
