...
export const MVP_LEAGUES: LeagueConfig[] = [
  ...
  { slug: "uefa-nations-league", name: "UEFA Nations League", apiFootballLeagueId: 5 },
  { slug: "friendlies", name: "Friendlies", apiFootballLeagueId: 10, eligibility: "SENIOR_INTERNATIONAL_ONLY" },
  { slug: "africa-cup-of-nations-qualification", name: "Africa Cup of Nations Qualification", apiFootballLeagueId: 36, eligibility: "SENIOR_INTERNATIONAL_ONLY" },
  ...
  { slug: "concacaf-nations-league", name: "CONCACAF Nations League", apiFootballLeagueId: 536, eligibility: "SENIOR_INTERNATIONAL_ONLY" },
